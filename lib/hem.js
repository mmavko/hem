...
(function() {
  ...
  Hem = (function() {
    ...
    Hem.prototype.server = function() {
      ...
      strata.map(this.options.cssPath, function(app) {
        return app.run(_this.cssPackage().createServer());
      });
      strata.map(this.options.jsPath, function(app) {
        return app.run(_this.hemPackage().createServer());
      });
      strata.map(this.options.testPath, function(app) {
        if (path.existsSync(_this.options.specs)) {
