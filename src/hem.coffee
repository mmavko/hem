...
class Hem
  ...
  server: ->
    ...
    # delete compiled files generated by probable previous 'build'
    for filepath in [path.join(@options.public, @options.jsPath), path.join(@options.public, @options.cssPath)]
